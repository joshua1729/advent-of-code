...
for x in range (0,100):
    for y in range(0,100):
        ...
        opcode[2]=y
        i=0
        while (i<len(opcode) and opcode[i]!=99):
            if opcode[i]==1:
                try:
                    opcode[opcode[i+3]]=opcode[opcode[i+1]]+opcode[opcode[i+2]]          
                except:
